...
class DownBlock(nn.Module):
    """
    A helper Module with 1 ResNet block and optional 1 MaxPool or 1 down convolution.
    """
    block_name: str
    out_channels: int
    use_down_conv: bool
    ...
    def setup(self):        
        self.res_block = ResnetBlock(
            ...
            name=f'{self.block_name}_resnet_block')
    ...
    def __call__(self, x: Array, cond: Array, deterministic: bool):
        ...
        h = self.res_block(x, cond = cond, deterministic = deterministic)[0]
