...
```
cd existing_repo
git remote add origin https://lab.compute.dtu.dk/bmgi/ddpm-exploration.git
git branch -M main
...
- [ ] [Set up project integrations](https://lab.compute.dtu.dk/bmgi/ddpm-exploration/-/settings/integrations)
